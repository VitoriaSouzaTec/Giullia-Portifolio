      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-primary/20 glow-primary">
          ...
          <div className="space-y-4 text-foreground/90 leading-relaxed">
            ...
            <p className="text-lg">
              Fala guys! Eu sou a Giullia Albertini, <span className="text-secondary font-semibold">criadora de conteúdo</span> com mais de <span className="text-primary font-semibold">oito anos de experiência</span> no universo digital. Minha especialidade é a produção de vídeos de <span className="text-secondary">humor, estilo de vida, streams, games</span> e análise de tendências.
            </p>
            
            {/* Parágrafo 2: Carreira Profissional (Veterinária) */}
            <p className="text-lg">
              Paralelamente, me dedico aos estudos com a minha paixão pelo mundo animal e em breve iniciarei minha carreira como <span className="text-primary font-semibold">Médica Veterinária</span>.
            </p>
